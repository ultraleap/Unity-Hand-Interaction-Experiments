...
namespace CurvedUI
{
    //Added to every UI object by CurvedUINoInput.
    ...
    public partial class CurvedUIVertexEffectNoInput : BaseMeshEffect
    {
        #region VARIABLES
        //public settings
        ...
        public CurvedUINoInput FindParentSettings(bool forceNew = false)
        {
            if (mySettings == null || forceNew)
            {
                mySettings = GetComponentInParent<CurvedUINoInput>();
