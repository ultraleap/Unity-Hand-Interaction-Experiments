...
using Leap.Unity.InputModuleAurora;
using Leap.Unity;
...
#pragma warning restore 414, 0649
    ...
    protected override void Awake() {
        ...
        Instance = this;
        base.Awake();
        leapInputModule = GameObject.FindObjectOfType<LeapInputModule>();
    ...
    public Ray GetEventRay(Camera eventCam = null) {
        ...
        switch (ControlMethod)
        {
            case CUIControlMethod.MOUSE:
            {
                ...
                return eventCam.ScreenPointToRay(leapInputModule.sharedPointerPos);
            }
